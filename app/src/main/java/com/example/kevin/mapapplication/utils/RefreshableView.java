...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    /**
     * 进行一些关键性的初始化操作，比如：将下拉头向上偏移进行隐藏，给S注册touch事件。
     */
    @Override
     ...
     * 的值，每次都需要在onTouch中第一个执行，这样可以判断出当前应该是滚动scrollview，还是应该进行下拉。
     *
     * @param event
     */
    private void setIsAbleToPull(MotionEvent event) {
        ...
        if (firstChild != null) {
            ...
            if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
                ...
                // 如果首个元素的上边缘，距离父布局值为0，就说明scrollview滚动到了最顶部，此时应该允许下拉刷新
                ableToPull = true;
            } else {
